...
INSERT INTO clientes (nome, email, telefone) VALUES ("Joãozinho", "joaozinho@uol.com", "27999877586");
INSERT INTO clientes (nome, email, telefone) VALUES ("maria", "maria@gmail.com", "2799997000");
INSERT INTO clientes (nome, email, telefone) VALUES ("pedrinho", "pedrinho@mysql.com.br", "27999969769");

- -  Veículos : Total 3

INSERT INTO veiculos (placa, ano, marca, id_cliente) VALUES ("PPK-5758", 2022, "Gol", 1);
INSERT INTO veiculos (placa, ano, marca, id_cliente) VALUES ("JDL-5867", 2022, "Honda", 2);
INSERT INTO veiculos (placa, ano, marca, id_cliente) VALUES ("ABC-1234", 2022, "FIAT", 3);

- -  Funcionários : Total 2 

- - Legenda para: status_funcionario: 0 - Inativo | 1 - Ativo

INSERT INTO funcionarios (nome, funcao, salario, matricula, status_funcionario) VALUES ("Cleitinho", "Gerente", 5050.50, 12345
INSERT INTO funcionarios (nome, funcao, salario, matricula, status_funcionario) VALUES ("Manuelzinho", "Vendedor", 1325.54, 12
...
- - Apagar todos os clientes com nome = “maria”:
